CREATE TABLE profiles (
    ...
    personal_photo MEDIUMBLOB NOT NULL,          -- Stores the personal photo of the user; this field cannot be NULL
    user_id BIGINT UNIQUE,                    -- A unique identifier linking this profile to a user in the 'users' table
